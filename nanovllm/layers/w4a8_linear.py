...
#   year={2025}
# }
import nanovllm.kernels.qgemm_w4a8_triton as qgemm_w4a8_triton
# import omniserve_backend.qgemm_w4a8_per_chn as qgemm_w4a8_cuda
import torch
...
class W4A8OF16LinearDynamicInputScale(torch.nn.Module):
    ...
    def forward_per_chn(self, x, input_scales, input_sum, output_buffer):
        qgemm_w4a8_triton.gemm_forward_triton(
        # qgemm_w4a8_cuda.gemm_forward_cuda(
            x,
            self.qweight,
            self.s1_scales,
            input_scales,
